...
2. Add API Gateway trigger to lambda function
dd click: trigger → Select API Gateway → Intent: Create new REST API → Security: Open → Add
...
6. Business Rule
    ...
    Advanced: ☑ Check this box (Crucial).
    Click: "When to run" Tab:
    When: After
    Insert: ☑ Checked
    Update: ☑ Checked
    ```
